	...
	struct dentry *parent)
{
	...
	debugfs_create_u32("ulps_feature_enabled", 0644, dfs->root,
			(u32 *)&pinfo->ulps_feature_enabled);
	debugfs_create_u32("ulps_suspend_enabled", 0644, dfs->root,
			(u32 *)&pinfo->ulps_suspend_enabled);
	debugfs_create_u32("esd_check_enabled", 0644, dfs->root,
			(u32 *)&pinfo->esd_check_enabled);
	debugfs_create_u32("panel_ack_disabled", 0644, dfs->root,
